...
for QUANT in q3f16_1 q4f16_1 q0f32; do
    ...
    MLC_HOME=$MLC_HOME python convert.py --model ${MODELS_PATH}/starcoder -b mlc -q $QUANT -t $BACKEND -v -d $OUTPUT_PATH/bigcode_starcoder -c ${CONFIGS_PATH}/starcoder-bigcode.yaml $EXTRA_COMPILE_ARGS
