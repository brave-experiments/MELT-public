...
python download.py -m TheBloke/Llama-2-7B-GPTQ -d ${OUTPUT_PATH} -t ${HUGGINGFACE_TOKEN}
python download.py -m TheBloke/Llama-2-13B-GPTQ -d ${OUTPUT_PATH} -t ${HUGGINGFACE_TOKEN}
python download.py -m TheBloke/starcoder-GPTQ -d ${OUTPUT_PATH} -t ${HUGGINGFACE_TOKEN}
...
python download.py -m TheBloke/Llama-2-7B-AWQ -d ${OUTPUT_PATH} -t ${HUGGINGFACE_TOKEN}
python download.py -m TheBloke/Llama-2-13B-AWQ -d ${OUTPUT_PATH} -t ${HUGGINGFACE_TOKEN}